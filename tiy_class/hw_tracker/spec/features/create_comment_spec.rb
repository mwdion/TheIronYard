...
describe "create project", type: :feature, js: true do
  it "should allow user to create project" do
    visit root_path
    ...
    fill_in "comment_content", with: "I love this BlackJack Project"
    click_button "Create Comment"
    expect(page).to have_content("I love this BlackJack Project")
  end
end